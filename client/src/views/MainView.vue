...
<template>
  ...
  <div class="modal fade" id="gcodeImageModal" tabindex="-1" aria-labelledby="gcodeImageModalLabel" aria-hidden="true"
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="gcodeImageModalLabel"><b>{{ currentJob?.printer }}:</b> {{ currentJob?.name }}
          </h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
  ...
  <div class="modal fade gcode-live-modal" id="gcodeLiveViewModal" tabindex="-1"
    aria-labelledby="gcodeLiveViewModalLaebl" aria-hidden="true" @shown.bs.modal="isGcodeLiveViewVisible = true"
            ...
            <td style="width: 1%; white-space: nowrap;">
              ...
              <div style="display: inline-flex;">
                <button type="button" class="btn btn-primary btn-circle me-2" data-bs-toggle="modal"
                  ...
                  v-bind:job="printer.queue[0]" @click="printer.name && openModal(printer.queue[0], printer.name, 0)">
                ...
                <button type="button" class="btn btn-info btn-circle" data-bs-toggle="modal"
                  ...
                  v-bind:job="printer.queue[0]" @click="printer.name && openModal(printer.queue[0], printer.name, 2)">
